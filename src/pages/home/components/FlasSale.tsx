import { EyeOutlined, HeartOutlined, RightOutlined, ShoppingCartOutlined, StarFilled } from '@ant-design/icons'
...
const FlasSale = (props: Props) => {
  return (
 <div className="ml-40 mr-40 mt-10 min-h-screen bg-gradient-to-br from-red-500 via-orange-400 to-yellow-300 p-8">
     <div className="flex items-center justify-between mb-8">
    <div className="flash-sale-title flex items-center gap-3">
      <svg
        className="flash-icon w-6 h-6 text-yellow-400"
        viewBox="0 0 24 24"
        fill="currentColor"
      >
    ...
    <div className="flex items-center w-auto h-10 bg-red-600 text-white px-4 py-1 rounded-lg font-mono text-sm select-none">
      <span>01</span>:<span>10</span>:<span>45</span>
    </div>
  </div>
